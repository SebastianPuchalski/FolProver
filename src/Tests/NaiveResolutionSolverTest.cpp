...
class NaiveResolutionSolverTest : public ::testing::Test {
protected:
    NaiveResolutionSolver solver;
...
TEST_F(NaiveResolutionSolverTest, SimplePropositionalContradiction) {
    // Clauses: { P }, { ~P }
...
TEST_F(NaiveResolutionSolverTest, SimplePropositionalSatisfiable) {
    // Clauses: { P }, { Q }
    auto clauses = std::vector<FormulaPtr>{
        Unit(Pred("P")),
        Unit(Pred("Q"))
...
TEST_F(NaiveResolutionSolverTest, ModusPonensContradiction) {
    // Clauses: { ~P, Q }, { P }, { ~Q }
    auto clauses = std::vector<FormulaPtr>{
...
TEST_F(NaiveResolutionSolverTest, SimpleUnification) {
    // Clauses: { P(x) }, { ~P(a) }
    auto clauses = std::vector<FormulaPtr>{
        Unit(Pred("P", {Var("x")})),
...
TEST_F(NaiveResolutionSolverTest, VariableIndependence) {
    // Clauses: { P(x) }, { ~P(y) }
...
// -> UNSAT
TEST_F(NaiveResolutionSolverTest, SocratesSyllogism) {
...
TEST_F(NaiveResolutionSolverTest, FunctionSymbolUnification) {
    auto clauses = std::vector<FormulaPtr>{
...
TEST_F(NaiveResolutionSolverTest, FactoringTest) {
    auto clauses = std::vector<FormulaPtr>{
...
TEST_F(NaiveResolutionSolverTest, OccursCheck) {
    auto clauses = std::vector<FormulaPtr>{
...
TEST_F(NaiveResolutionSolverTest, EmptyClauseSet) {
    auto clauses = std::vector<FormulaPtr>{};
    auto result = solve(clauses);
    EXPECT_EQ(result, FolSatSolver::Result::SATISFIABLE);
}
...
TEST_F(NaiveResolutionSolverTest, ContainsEmptyClause) {
    auto clauses = std::vector<FormulaPtr>{
...
TEST_F(NaiveResolutionSolverTest, PeanoTransitivityCombo) {
    auto x = Var("x");
    auto y = Var("y");
    auto z = Var("z");
    auto zero = Func("zero");
...
TEST_F(NaiveResolutionSolverTest, GraphConnectivity) {
    auto a = Func("a");
    auto b = Func("b");
    auto c = Func("c");
    auto d = Func("d");
...
TEST_F(NaiveResolutionSolverTest, WhodunitLogicPuzzle) {
    // Constants
...
TEST_F(NaiveResolutionSolverTest, ConsistentEcosystem) {
    auto lion = Func("lion");
...
TEST_F(NaiveResolutionSolverTest, TheBarberParadox) {
...
TEST_F(NaiveResolutionSolverTest, Distinct_17_StringInequality) {
...
// Input: 123 = 456
// Result: False -> Empty Clause -> UNSAT.
TEST_F(NaiveResolutionSolverTest, Distinct_18_NumericInequality) {
...
TEST_F(NaiveResolutionSolverTest, Distinct_19_Tautology) {
    auto x = Var("x");
    auto A = Distinct("\"A\"");
    auto B = Distinct("\"B\"");
...
TEST_F(NaiveResolutionSolverTest, Distinct_20_ResolutionSubstitution) {
    auto x = Var("x");
...
TEST_F(NaiveResolutionSolverTest, Distinct_21_Pigeonhole) {
    auto x = Var("x");
    auto A = Distinct("\"A\"");
    auto B = Distinct("\"B\"");
    auto C = Distinct("\"C\"");
...
TEST_F(NaiveResolutionSolverTest, Distinct_22_NestedSubstitution) {
    auto x = Var("x");
...
TEST_F(NaiveResolutionSolverTest, Distinct_23_MegaIntegrityCascade) {
...
TEST_F(NaiveResolutionSolverTest, Eq_24_Reflexivity) {
    auto a = Func("a");
...
// Goal: Prove b = a.
// Complexity: Low.
TEST_F(NaiveResolutionSolverTest, Eq_25_Symmetry) {
    auto a = Func("a");
    auto b = Func("b");
...
// Goal: Prove P(b).
// Complexity: Medium.
TEST_F(NaiveResolutionSolverTest, Eq_26_PredicateSubstitution) {
    auto a = Func("a");
    auto b = Func("b");
...
// Goal: Prove f(a) = f(b).
// Complexity: Medium.
TEST_F(NaiveResolutionSolverTest, Eq_27_FunctionSubstitution) {
    auto a = Func("a");
    auto b = Func("b");
...
// Goal: Prove a = c.
// Complexity: Medium.
TEST_F(NaiveResolutionSolverTest, Eq_28_Transitivity_Short) {
    auto a = Func("a");
    auto b = Func("b");
    auto c = Func("c");
...
TEST_F(NaiveResolutionSolverTest, Eq_29_SymmetrySubstitution) {
    auto a = Func("a");
    auto b = Func("b");
...
TEST_F(NaiveResolutionSolverTest, Eq_30_TransitivityAndFunction) {
    auto a = Func("a");
    auto b = Func("b");
    auto c = Func("c");
    auto f = [](TermPtr t) { return Func("f", { t }); };
...
TEST_F(NaiveResolutionSolverTest, Eq_31_VariableIdentity) {
