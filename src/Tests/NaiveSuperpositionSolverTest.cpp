...
class NaiveSuperpositionSolverTest : public ::testing::Test {
protected:
    NaiveSuperpositionSolver solver;
...
TEST_F(NaiveSuperpositionSolverTest, SimplePropositionalContradiction) {
    // Clauses: { P }, { ~P }
...
TEST_F(NaiveSuperpositionSolverTest, SimplePropositionalSatisfiable) {
    // Clauses: { P }, { Q }
    auto clauses = std::vector<FormulaPtr>{
        Unit(Pred("P")),
        Unit(Pred("Q"))
...
TEST_F(NaiveSuperpositionSolverTest, ModusPonensContradiction) {
    // Clauses: { ~P, Q }, { P }, { ~Q }
    auto clauses = std::vector<FormulaPtr>{
...
TEST_F(NaiveSuperpositionSolverTest, SimpleUnification) {
    // Clauses: { P(x) }, { ~P(a) }
    auto clauses = std::vector<FormulaPtr>{
        Unit(Pred("P", {Var("x")})),
...
TEST_F(NaiveSuperpositionSolverTest, VariableIndependence) {
    // Clauses: { P(x) }, { ~P(y) }
...
// -> UNSAT
TEST_F(NaiveSuperpositionSolverTest, SocratesSyllogism) {
...
TEST_F(NaiveSuperpositionSolverTest, FunctionSymbolUnification) {
    auto clauses = std::vector<FormulaPtr>{
...
TEST_F(NaiveSuperpositionSolverTest, FactoringTest) {
    auto clauses = std::vector<FormulaPtr>{
...
TEST_F(NaiveSuperpositionSolverTest, OccursCheck) {
    auto clauses = std::vector<FormulaPtr>{
...
TEST_F(NaiveSuperpositionSolverTest, EmptyClauseSet) {
    auto clauses = std::vector<FormulaPtr>{};
    auto result = solve(clauses);
    EXPECT_EQ(result, FolSatSolver::Result::SATISFIABLE);
}
...
TEST_F(NaiveSuperpositionSolverTest, ContainsEmptyClause) {
    auto clauses = std::vector<FormulaPtr>{
...
TEST_F(NaiveSuperpositionSolverTest, PeanoTransitivityCombo) {
    auto x = Var("x");
    auto y = Var("y");
    auto z = Var("z");
    auto zero = Func("zero");
...
TEST_F(NaiveSuperpositionSolverTest, WhodunitLogicPuzzle) {
    // Constants
...
TEST_F(NaiveSuperpositionSolverTest, ConsistentEcosystem) {
    auto lion = Func("lion");
...
TEST_F(NaiveSuperpositionSolverTest, TheBarberParadox) {
...
TEST_F(NaiveSuperpositionSolverTest, Distinct_17_StringInequality) {
...
// Input: 123 = 456
// Result: False -> Empty Clause -> UNSAT.
TEST_F(NaiveSuperpositionSolverTest, Distinct_18_NumericInequality) {
...
TEST_F(NaiveSuperpositionSolverTest, Distinct_19_Tautology) {
    auto x = Var("x");
    auto A = Distinct("\"A\"");
    auto B = Distinct("\"B\"");
...
TEST_F(NaiveSuperpositionSolverTest, Distinct_20_ResolutionSubstitution) {
    auto x = Var("x");
...
TEST_F(NaiveSuperpositionSolverTest, Distinct_21_Pigeonhole) {
    auto x = Var("x");
    auto A = Distinct("\"A\"");
    auto B = Distinct("\"B\"");
    auto C = Distinct("\"C\"");
...
TEST_F(NaiveSuperpositionSolverTest, Distinct_22_NestedSubstitution) {
    auto x = Var("x");
...
TEST_F(NaiveSuperpositionSolverTest, Distinct_23_MegaIntegrityCascade) {
...
TEST_F(NaiveSuperpositionSolverTest, Eq_24_Reflexivity) {
    auto a = Func("a");
...
// Goal: Prove b = a.
// Complexity: Low.
TEST_F(NaiveSuperpositionSolverTest, Eq_25_Symmetry) {
    auto a = Func("a");
    auto b = Func("b");
...
// Goal: Prove P(b).
// Complexity: Medium.
TEST_F(NaiveSuperpositionSolverTest, Eq_26_PredicateSubstitution) {
    auto a = Func("a");
    auto b = Func("b");
...
// Goal: Prove f(a) = f(b).
// Complexity: Medium.
TEST_F(NaiveSuperpositionSolverTest, Eq_27_FunctionSubstitution) {
    auto a = Func("a");
    auto b = Func("b");
...
// Goal: Prove a = c.
// Complexity: Medium.
TEST_F(NaiveSuperpositionSolverTest, Eq_28_Transitivity_Short) {
    auto a = Func("a");
    auto b = Func("b");
    auto c = Func("c");
...
TEST_F(NaiveSuperpositionSolverTest, Eq_29_SymmetrySubstitution) {
    auto a = Func("a");
    auto b = Func("b");
...
TEST_F(NaiveSuperpositionSolverTest, Eq_30_TransitivityAndFunction) {
    auto a = Func("a");
    auto b = Func("b");
    auto c = Func("c");
    auto f = [](TermPtr t) { return Func("f", { t }); };
...
TEST_F(NaiveSuperpositionSolverTest, Eq_31_VariableIdentity) {
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_BasicSymmetry) {
    auto a = Func("a");
    auto b = Func("b");
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_EqualityCommutativity) {
    auto a = Func("a");
    auto b = Func("b");
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_TransitivityChain) {
    auto a = Func("a");
    auto b = Func("b");
    auto c = Func("c");
    auto d = Func("d");
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_EqualityResolution) {
    auto x = Var("x");
    auto y = Var("y");
    auto a = Func("a");
    auto b = Func("b");
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_FunctionClash) {
    auto x = Var("x");
    auto a = Func("a");
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_DisjointVariables) {
    auto x = Var("x");
    auto y = Var("y");
    auto a = Func("a");
    auto b = Func("b");
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_RepeatedVariablesConstraint) {
    auto x = Var("x");
    auto a = Func("a");
    auto c = Func("c");
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_DeepNestedCongruence) {
    auto a = Func("a");
    auto b = Func("b");
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_RootOverlap) {
    auto x = Var("x");
    auto a = Func("a");
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_AxiomInstantiation) {
    auto x = Var("x");
    auto a = Func("a");
    auto f = [](TermPtr t) { return Func("f", { t }); };
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_RecursiveRewrite) {
    auto x = Var("x");
    auto a = Func("a");
    auto f = [](TermPtr t) { return Func("f", { t }); };
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_NonUnitInteraction) {
    auto a = Func("a");
    auto b = Func("b");
    auto Q = Pred("Q");
...
// f(x)=a OR g(x)=b.
TEST_F(NaiveSuperpositionSolverTest, Superposition_DisjunctiveVarContext) {
    auto x = Var("x");
    auto a = Func("a");
    auto b = Func("b");
    auto c = Func("c");
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_BuriedEquality) {
    auto x = Var("x");
    auto a = Func("a");
    auto b = Func("b");
...
// f(x, y) = f(y, x).
TEST_F(NaiveSuperpositionSolverTest, Superposition_CommutativityAxiom) {
    auto x = Var("x");
    auto y = Var("y");
    auto a = Func("a");
    auto b = Func("b");
...
// 47. ASSOCIATIVITY
TEST_F(NaiveSuperpositionSolverTest, Superposition_Associativity) {
    auto x = Var("x");
    auto y = Var("y");
    auto z = Var("z");
    auto a = Func("a");
...
// 48. DISTRIBUTIVITY
TEST_F(NaiveSuperpositionSolverTest, Superposition_Distributivity) {
    auto x = Var("x");
    auto y = Var("y");
    auto z = Var("z");
    auto a = Func("a");
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_ListReduction) {
    auto x = Var("x");
    auto y = Var("y");
    auto a = Func("a");
    auto b = Func("b");
...
// 50. BOOLEAN CHAIN
TEST_F(NaiveSuperpositionSolverTest, Superposition_BooleanChain) {
    auto T = Func("true");
    auto F = Func("false");
...
// 51. CYCLIC ROTATION
// k(x,y,z) = k(y,z,x).
TEST_F(NaiveSuperpositionSolverTest, Superposition_CyclicRotation) {
    auto x = Var("x");
    auto y = Var("y");
    auto z = Var("z");
    auto a = Func("a");
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_RewriteInsideEquality) {
    auto a = Func("a");
    auto b = Func("b");
    auto c = Func("c");
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_RewriteInsidePredicate) {
    auto a = Func("a");
    auto b = Func("b");
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_VariableAbstraction) {
    auto x = Var("x");
    auto a = Func("a");
    auto b = Func("b");
...
// a=b, a=c -> b=c.
TEST_F(NaiveSuperpositionSolverTest, Superposition_PositiveSuperposition) {
    auto a = Func("a");
    auto b = Func("b");
    auto c = Func("c");
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_MixedTransitivity) {
    auto a = Func("a");
    auto b = Func("b");
    auto c = Func("c");
...
// eq(a,b)=true check.
TEST_F(NaiveSuperpositionSolverTest, Superposition_SimulatedHigherOrderEq) {
    auto x = Var("x");
    auto a = Func("a");
    auto b = Func("b");
    auto T = Func("true");
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_ParamodFromNonUnit) {
    auto a = Func("a");
    auto b = Func("b");
    auto P = Pred("P");
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_TransitivityAcrossDisjunction) {
    auto a = Func("a");
    auto b = Func("b");
    auto c = Func("c");
    auto d = Func("d");
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_DomainCardinality) {
    auto x = Var("x");
    auto a = Func("a");
    auto b = Func("b");
    auto c = Func("c");
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_EqualityFactoringImplicit) {
    auto a = Func("a");
    auto b = Func("b");
    auto c = Func("c");
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_EqualityFactoringMerge) {
    auto x = Var("x");
    auto y = Var("y");
    auto a = Func("a");
    auto b = Func("b");
...
// 65.
// a=b & Q(a) -> Q(b).
TEST_F(NaiveSuperpositionSolverTest, Superposition_SelfParamodulation) {
    auto a = Func("a");
    auto b = Func("b");
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_DistinctPropagation) {
    auto x = Var("x");
    auto a = Func("a");
...
TEST_F(NaiveSuperpositionSolverTest, Superposition_DistinctClausePruning) {
    auto a = Func("a");
    auto d1 = Distinct("D1");
    auto d2 = Distinct("D2");
...
TEST_F(NaiveSuperpositionSolverTest, FunctionCongruence_FastUnsat) {
    auto a = Func("a");
    auto b = Func("b");
    auto c = Func("c");
    auto d = Func("d");
...
TEST_F(NaiveSuperpositionSolverTest, Doppelganger_SelfInteraction) {
    auto a = Func("a");
    auto b = Func("b");
    auto x = Var("x");
    auto f = "f";
...
TEST_F(NaiveSuperpositionSolverTest, EqualitySymmetry_SimpleMismatch) {
